...
//
public class GunViolencePlotter : MonoBehaviour
{
    ...
    public int column13 = 12;
    public int column14 = 13;
    public int column15 = 14;
    public int column16 = 15;
    public int column17 = 16;
    public int column18 = 17;
    public int column19 = 18;
    public int column20 = 19;
    public int column21 = 20;
    public int column22 = 21;
    public int column23 = 22;
    public int column24 = 23;
    public int column25 = 24;
    public int column26 = 25;
    public int column27 = 26;
    public int column28 = 27;
    public int column29 = 28;
    ...
    public string jColumnName;
    public string kColumnName;
    public string lColumnName;
    public string mColumnName;
    public string nColumnName;
    public string oColumnName;
    public string pColumnName;
    public string qColumnName;
    public string rColumnName;
    public string sColumnName;
    public string tColumnName;
    public string uColumnName;
    public string vColumnName;
    public string wColumnName;
    public string abcolumnName;
    public string acColumnName;
    public string adColumnName;
    // public string aEColumnName;
    ...
    void Awake()
	{
        ...
        jColumnName = columnList[column13];
        kColumnName = columnList[column14];
        lColumnName = columnList[column15];
        mColumnName = columnList[column16];
        nColumnName = columnList[column17];
        oColumnName = columnList[column18];
        pColumnName = columnList[column19];
        qColumnName = columnList[column20];
        rColumnName = columnList[column21];
        sColumnName = columnList[column22];
        tColumnName = columnList[column23];
        uColumnName = columnList[column24];
        vColumnName = columnList[column25];
        wColumnName = columnList[column26];
        //abColumnName = columnList[column27];
        acColumnName = columnList[column28];
        adColumnName = columnList[column29];
	...
	private void PlacePrefabPoints()
	{
                ...
                for (var i = 0; i < pointList.Count; i++)
        {
            ...
            //OK SO X IS GOING TO BE COLUMN 1 (incidentID)            
            //Y IS GOING TO BE COLUMN 6 (number killed)
            //Z IS GOING TO BE COLUMN 7 (Number injured)
            float x = (Convert.ToSingle(pointList[i][xColumnName]) - xMin) / (xMax - xMin);
            float y = (Convert.ToSingle(pointList[i][cColumnName]) - yMin) / (yMax - yMin);
            float z = (Convert.ToSingle(pointList[i][dColumnName]) - zMin) / (zMax - zMin);
            //string a = (Convert.ToString(pointList[i][cColumnName]));
            ...
            // bc.isTrigger = true;
           GunViolenceHolder Gholder = dataPoint.AddComponent<GunViolenceHolder>();
           Gholder.ID = System.Convert.ToSingle(pointList[i][xColumnName]);
           Gholder.date = (pointList[i][yColumnName]).ToString();
           Gholder.state = (pointList[i][zColumnName]).ToString();
           Gholder.nGunsInvolved = (pointList[i][oColumnName]).ToString(); //column 18
           Gholder.nKilled = x;
           Gholder.nInjured = z;
           Gholder.gunStolen = (pointList[i][iColumnName]).ToString();  //column 12
           Gholder.gunType =  (pointList[i][jColumnName]).ToString(); //column 13
